...
- RQ3 prompt reviewed and updated with 7 fixes: RQ1/RQ2 context block,
  "do NOT substitute" guard, retrieve-first for ground truth, fresh
  publish as baseline, comprehensive restore (git clean for new dirs),
